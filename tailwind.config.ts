  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        headline: ['var(--font-soehne)', 'Söhne', 'Soehne', '-apple-system', 'BlinkMacSystemFont', 'SF Pro Display', 'Inter', 'sans-serif'],
        soehne: ['var(--font-soehne)', 'Söhne', 'Soehne', '-apple-system', 'BlinkMacSystemFont', 'SF Pro Display', 'Inter', 'sans-serif'],
      },
      colors: {

    ...
    <section className="relative flex flex-col justify-between min-h-[90vh] lg:min-h-screen w-full overflow-hidden bg-[#050505] text-white pt-24 pb-0 selection:bg-red-600 selection:text-white">
      ...
      <div className="absolute inset-0 pointer-events-none z-0 opacity-40">
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="isometric-cube-pattern" width="60" height="103.923" patternUnits="userSpaceOnUse">
            ...
            <pattern id="dot-matrix-pattern" width="16" height="16" patternUnits="userSpaceOnUse">
              <circle cx="2" cy="2" r="1.5" fill="rgba(255, 255, 255, 0.18)" />
            </pattern>

            {/* Corner Masks for Dot Gradients */}
            <radialGradient id="top-left-mask" cx="0%" cy="0%" r="50%">
              <stop offset="0%" stopColor="white" stopOpacity="1" />
              <stop offset="100%" stopColor="white" stopOpacity="0" />
            </radialGradient>
            <radialGradient id="bottom-right-mask" cx="100%" cy="100%" r="50%">
              <stop offset="0%" stopColor="white" stopOpacity="1" />
              <stop offset="100%" stopColor="white" stopOpacity="0" />
            </radialGradient>
          </defs>
          ...
          <rect width="100%" height="100%" fill="url(#isometric-cube-pattern)" />
        </svg>
      </div>
      ...
      <div 
        className="absolute bottom-24 right-0 w-80 h-80 sm:w-96 sm:h-96 pointer-events-none z-0 opacity-60"
        style={{
      ...
      <div className="container relative z-10 mx-auto px-6 max-w-5xl text-center my-auto py-12 sm:py-20 flex flex-col items-center justify-center">
        ...
        <h1 className="font-soehne text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight text-white leading-[1.2] max-w-4xl mx-auto">
          ...
          <span className="text-white">AI-Driven Solutions</span>
        </h1>

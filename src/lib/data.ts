...
export const portfolioProjects = [
  {
    slug: 'shiv-mahaluxmi-solar',
    title: 'Shiv Mahaluxmi Solar Energy',
    description: 'Best Solar Company in Meerut | Rooftop Solar Installer for Commercial & Residential.',
    tags: ['Solar Energy', 'Rooftop Solar'],
    category: 'Solar EPC',
    websiteUrl: 'https://shivmahaluxmisolar.com/',
    image: {
      id: 'shiv-mahaluxmi',
      description: 'Shiv Mahaluxmi Solar Energy',
      imageUrl: '/pot/shiv mahaluxmi.png',
      imageHint: 'solar rooftop installer website',
    },
  },
  {
    slug: 'ons-sustainable-energy',
    title: 'ONS Sustainable Energy Solutions',
    description: 'Solar EPC Company in India | Residential, Commercial & Industrial Solar.',
    tags: ['Solar EPC', 'Sustainable Energy'],
    category: 'Solar EPC',
    websiteUrl: 'https://ons.co.in/',
    image: {
      id: 'ons-energy',
      description: 'ONS Sustainable Energy Solutions',
      imageUrl: '/pot/ONS Sustainable Energy.png',
      imageHint: 'solar epc company india',
    },
  },
  {
    slug: 'sky-renewable',
    title: 'Sky Renewable',
    description: 'A Complete Solar Solution providing turn-key solar power engineering & installations.',
    tags: ['Renewable Energy', 'Green Tech'],
    category: 'Solar EPC',
    websiteUrl: 'https://skyrenewable.in/',
    image: {
      id: 'sky-renewable',
      description: 'Sky Renewable Solar Solutions',
      imageUrl: '/pot/sky renewable.png',
      imageHint: 'complete solar solution',
    },
  },
  {
    slug: 'ada-chikankari',
  ...
  },
  {
    ...
    tags: ['SaaS'],
    category: 'AI Tools',
    image: findImage('p-ai-sales-crm'),
  },
  {
    slug: 'rozana',
    title: 'FOOD APP',
  ...
  },
  {
    ...
    description: 'Long-term SEO and content strategy that resulted in a 300% increase in organic traffic.',
    tags: ['B2B Strategy'],
    category: 'Web/App',
  ...
  {
    slug: 'political-dashboard',
    title: 'Political Dashboard',
    description: 'AI-powered dashboard for real-time sentiment analysis and constituency monitoring.',
    tags: ['Political Tech'],
    category: 'Political Tech',
    image: findImage('p-political-dashboard'),
  },
  {
    slug: 'ed-tech-portal',
    title: 'Ed-Tech Portal',
    description: 'An online learning platform with interactive courses and student management tools.',
    tags: ['School Website'],
    category: 'Web/App',
    image: findImage('p-ed-tech'),
  },
  {
    slug: 'corporate-website',
    title: 'Corporate Website',
    description: 'A modern, professional website for a multinational financial services firm.',
    tags: ['Corporate Website'],
    category: 'Web/App',
    image: findImage('p-corporate-website'),
  },
  {
    slug: 'yoga-app',
    title: 'Yoga App',
    description: 'A mobile app offering guided yoga sessions, progress tracking, and community features.',
    tags: ['App'],
    category: 'Web/App',
    image: findImage('p-yoga-app'),
  },
  {
    slug: 'enterprise-erp',
    ...
    tags: ['Web App'],
    category: 'AI Tools',
    image: findImage('p-enterprise-erp'),
  },
  {
    slug: 'ai-chatbot',
    title: 'AI Chatbot',
    description: 'AI-powered chatbot for customer support, reducing response times by 60%.',
    tags: ['AI Tools'],
    category: 'AI Tools',
    image: findImage('p-ai-chatbot'),
  },
  {
    slug: 'project-management-saas',
    title: 'Project Management SaaS',
    description: 'A multi-tenant SaaS application with core project management features.',
    tags: ['SaaS'],
    category: 'Web/App',
    image: findImage('p-pm-saas'),
  },
  {
    slug: 'cloud-migration-service',
    title: 'Cloud Migration Service',
    description: 'Seamlessly migrated a legacy enterprise system to a modern cloud infrastructure.',
    tags: ['Cloud'],
    category: 'AI Tools',
    image: findImage('p-cloud-migration'),
  },
];
...
export const saasProducts = [
  {
    ...
    tagline: 'Multi-channel Campaign & Lead Nurturing Engine',
    description: 'Proprietary automated marketing engine designed to nurture leads, execute automated WhatsApp & email campaigns, and track ROI in real-time.',
    badge: 'Proprietary SaaS Product 1',
  },
  {
    slug: 'hrms-software',
    title: 'HRMS (Human Resource Management System)',
    tagline: 'Complete Workplace & Payroll Automation SaaS',
    description: 'Enterprise HR management platform for automated attendance, leave tracking, payroll processing, performance metrics, and onboarding.',
    badge: 'Proprietary SaaS Product 2',
  },
  {
    slug: 'ai-sales-crm',
    title: 'AI Sales CRM & Lead Intelligence',
    tagline: 'Predictive Lead Qualification & Revenue Engine',
    description: 'Smart CRM platform powered by predictive AI for real-time lead scoring, automated routing, and sales pipeline optimization.',
    badge: 'Proprietary SaaS Product 3',
  },
];

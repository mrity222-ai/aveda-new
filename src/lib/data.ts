...
export const portfolioProjects = [
  {
    ...
    results: 'Reduced data analysis time by 40%.',
    image: findImage('portfolio-fintech'),
  },
  {
    slug: 'political-sentiment-ai',
    title: 'Political Sentiment AI',
    category: 'Political Tech',
    industry: 'Political Campaigning',
    clientGoal: 'To analyze real-time voter sentiment across social media platforms.',
    solution: 'An AI-powered platform that tracks keywords, identifies trends, and provides actionable insights for campaign strategy.',
    technologies: ['Python', 'TensorFlow', 'Next.js', 'Firebase'],
    results: '15% shift in positive sentiment.',
    image: findImage('service-political-dashboard'),
  },
  {
    slug: 'crm-automation-ai',
    title: 'CRM Automation AI',
    category: 'AI Tools',
    industry: 'Startups',
    clientGoal: 'To automate lead scoring and follow-ups within the company CRM.',
    solution: 'An AI model integrated with Salesforce that predicts lead quality and triggers automated email sequences.',
    technologies: ['Salesforce API', 'Python', 'Scikit-learn'],
    results: 'Saved 20+ hours/week for the sales team.',
    image: findImage('service-ai'),
  },
  {
  ...
  },
  {
    ...
    results: 'Secured seed funding in 3 months.',
  ...
  },
  {
    ...
    results: 'Improved conversion rate by 30%.',

...
export default function PricingPage() {
  ...
  return (
    <div className="bg-background text-foreground">
      ...
      <section className="bg-secondary py-14 md:py-14">
      ...
      <section className="bg-background py-14 md:py-14">
                 ...
                 {testimonials.map((testimonial) => {
                     ...
                     return (
                        <Card key={testimonial.name} className="relative overflow-hidden border bg-card shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
                          <div className="absolute top-4 left-4 text-7xl font-bold text-primary/10 opacity-90">“</div>

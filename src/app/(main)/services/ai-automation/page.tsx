...
export default function AiAutomationPage() {
    ...
    return (
        <div className="bg-background text-foreground">
            ...
            <section className="relative pt-28 pb-16 md:pt-36 md:pb-24 bg-[#050505] text-white border-b border-slate-800/80 overflow-hidden">
                ...
                <div className="container relative z-10 mx-auto px-6 max-w-4xl text-center">
                    ...
                    <p className="font-inter text-base sm:text-lg lg:text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed font-normal mb-8">
                        We design intelligent AI automation workflows and generative AI agents that reduce operational costs, eliminate manual work, and accelerate revenue.
                    </p>
                    ...
                    <div className="flex flex-wrap justify-center items-center gap-4">
                        ...
                        <Button asChild size="lg" variant="outline" className="h-13 px-8 text-sm font-bold border-slate-300 bg-white text-slate-900 hover:bg-slate-50 rounded-full transition-all">
            ...
            <section className="bg-background py-8 md:py-11 relative">
                ...
                <div className="container relative">
                    <div className="mx-auto max-w-3xl text-center mb-6">
                        <h2 className="font-headline text-base sm:text-xl lg:text-2xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Is Your Business Stuck in Manual Chaos?</h2>
                        <p className="mt-4 text-xs sm:text-sm text-muted-foreground">Common symptoms we see every day. Does any of this sound familiar?</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                        ...
                        <div className="group rounded-2xl border border-destructive/20 bg-card p-6 shadow-[0_0_15px_hsl(var(--destructive)/0.1)] transition-all duration-300 hover:shadow-[0_0_30px_hsl(var(--destructive)/0.2)] hover:-translate-y-2 hover:animate-shake">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="font-semibold text-lg bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Inconsistent Follow-ups</h3>
                                    <p className="text-muted-foreground mt-1 text-[10px]">Leads are coming in but your sales team can't keep up, letting potential revenue slip away.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="group rounded-2xl border border-destructive/20 bg-card p-6 shadow-[0_0_15px_hsl(var(--destructive)/0.1)] transition-all duration-300 hover:shadow-[0_0_30px_hsl(var(--destructive)/0.2)] hover:-translate-y-2 hover:animate-shake">
                            <div className="flex items-start gap-4">
                                <XCircle className="h-8 w-8 text-destructive flex-shrink-0 drop-shadow-[0_0_5px_hsl(var(--destructive)/0.8)]" />
                                <div>
                                    <h3 className="font-semibold text-lg bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Overwhelmed Teams</h3>
                                    <p className="text-muted-foreground mt-1 text-[10px]">Your team is bogged down by repetitive, manual tasks, leading to burnout and low morale.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="group rounded-2xl border border-destructive/20 bg-card p-6 shadow-[0_0_15px_hsl(var(--destructive)/0.1)] transition-all duration-300 hover:shadow-[0_0_30px_hsl(var(--destructive)/0.2)] hover:-translate-y-2 hover:animate-shake">
                            <div className="flex items-start gap-4">
                                <XCircle className="h-8 w-8 text-destructive flex-shrink-0 drop-shadow-[0_0_5px_hsl(var(--destructive)/0.8)]" />
                                <div>
                                    <h3 className="font-semibold text-lg bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Slow Sales Processes</h3>
                                    <p className="text-muted-foreground mt-1 text-[10px]">Manual processes create bottlenecks in your sales cycle, delaying deals and frustrating customers.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="group rounded-2xl border border-destructive/20 bg-card p-6 shadow-[0_0_15px_hsl(var(--destructive)/0.1)] transition-all duration-300 hover:shadow-[0_0_30px_hsl(var(--destructive)/0.2)] hover:-translate-y-2 hover:animate-shake lg:col-span-2">
                             <div className="flex items-start gap-4">
                                <XCircle className="h-8 w-8 text-destructive flex-shrink-0 drop-shadow-[0_0_5px_hsl(var(--destructive)/0.8)]" />
                                <div>
                                    <h3 className="font-semibold text-lg bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Inefficient Content Creation</h3>
                        ...
                        <div className="group rounded-2xl border border-destructive/20 bg-card p-6 shadow-[0_0_15px_hsl(var(--destructive)/0.1)] transition-all duration-300 hover:shadow-[0_0_30px_hsl(var(--destructive)/0.2)] hover:-translate-y-2 hover:animate-shake">
                             <div className="flex items-start gap-4">
                                <XCircle className="h-8 w-8 text-destructive flex-shrink-0 drop-shadow-[0_0_5px_hsl(var(--destructive)/0.8)]" />
                                <div>
                                    <h3 className="font-semibold text-lg bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Lack of Data Insights</h3>
                    ...
                    <div className="mt-16 border-t-2 border-dashed border-destructive/20 pt-12 text-center max-w-3xl mx-auto">
                        <p className="text-2xl font-headline font-semibold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">If this sounds familiar, your business doesn’t need more staff.</p>
            ...
            {/* Smart Messaging Automation (WhatsApp Automation) */}
            <WhatsAppAutomation />
            ...
            <section className="bg-secondary py-20 md:py-28 relative">
                ...
                <div className="container relative z-10">
                    <div className="mx-auto max-w-4xl text-center">
                        <h2 className="font-headline text-3xl font-bold md:text-4xl bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">We Build AI Systems That Work 24/7 So You Don’t Have To</h2>
            ...
            <section className="bg-background py-20 md:py-28 relative">
                <div className="container relative z-10">
                    <h2 className="text-center font-headline text-3xl font-bold md:text-4xl mb-24 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Our 4-Step AI Implementation Framework</h2>
                        ...
                        {processSteps.map((step, index) => (
                            <div key={step.title} className={cn("relative mb-12 flex items-center w-full", index % 2 === 0 ? "justify-start" : "justify-end")}>
                                ...
                                <div className={cn(
                                    ...
                                    <div className="relative">
                                        <h3 className="font-headline text-xl font-semibold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Step {index + 1} – {step.title}</h3>
            ...
            <section className="bg-secondary py-20 md:py-28 relative">
                ...
                <div className="container relative z-10">
                    <div className="mx-auto max-w-4xl text-center">
                        <h2 className="font-headline text-3xl font-bold md:text-4xl bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Why Businesses Choose Aveda Technologies</h2>
                    </div>
                        ...
                        {benefits.map((item, index) => (
                            ...
                            >
                                <div className="flex items-start gap-4">
                                    ...
                                    <h3 className="font-headline text-lg font-semibold leading-tight pt-1 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">{item.title}</h3>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <section className="bg-background py-20 md:py-28 relative overflow-hidden">
                ...
                <div className="container text-center relative z-10">
                    <h2 className="font-headline text-3xl font-bold md:text-4xl mb-24 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Our Technology Stack</h2>
            ...
            <section className="bg-secondary py-20 md:py-28 relative">
                ...
                <div className="container relative z-10">
                    <div className="mx-auto max-w-3xl text-center mb-16">
                        <h2 className="font-headline text-3xl font-bold md:text-4xl bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Real Business Impact</h2>
            ...
            <section className="bg-background py-20 md:py-28 relative">
                ...
                <div className="container relative">
                    <div className="mx-auto max-w-3xl text-center mb-12">
                        <h2 className="font-headline text-3xl font-bold md:text-4xl bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Flexible AI Packages for Every Stage of Growth</h2>
            ...
            <CtaSection
              ...
              description="Stop relying on manual processes. Partner with our team to build an intelligent, automated growth engine."
              primaryCtaText="Start Project"
              primaryCtaLink="/contact?service=AI+Automation"

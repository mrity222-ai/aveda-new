        ...
        <div className="bg-background text-foreground">
            ...
            <section className="bg-background py-20 md:py-28 relative">
                ...
                <div className="container relative">
                    <div className="mx-auto max-w-3xl text-center mb-16">
                        <h2 className="font-headline text-3xl font-bold md:text-4xl bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Is Your Business Stuck in Manual Chaos?</h2>
             ...
             <section className="bg-background py-20 md:py-28">
                <div className="container">
                    <div className="text-center mb-16">
                        <h2 className="font-headline text-3xl font-bold md:text-4xl bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Visualizing Intelligent Automation</h2>
            ...
            <section className="relative overflow-hidden border-t border-border bg-card py-20">
                <div className="absolute inset-0 z-0 opacity-10">
                    {PlaceHolderImages.find((img) => img.id === 'service-ai') && (
                        <Image
                            src={PlaceHolderImages.find((img) => img.id === 'service-ai')!.imageUrl}
                            alt="Ready to Transform Your Business with AI? background"
                            fill
                            className="object-cover"
                            data-ai-hint={PlaceHolderImages.find((img) => img.id === 'service-ai')!.imageHint}
                        />
                    )}

...
export default function DeepakYadavPage() {
  ...
  return (
    <div className="bg-background text-foreground">
      ...
      {/* Founder Section */}
      <section className="relative bg-background py-14 md:py-14">
      ...
      {/* Our Mission Section */}
      <section className="bg-secondary py-14 md:py-14 relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-0 -translate-y-1/2 -translate-x-1/2 w-96 h-96 bg-primary/10 rounded-full blur-3xl -z-10 opacity-90"></div>
        <div className="absolute top-1/2 right-0 -translate-y-1/2 translate-x-1/2 w-96 h-96 bg-accent/10 rounded-full blur-3xl -z-10 opacity-90"></div>
        <div className="container relative z-10 text-center">
